...
- [X] T051 Kod seviyesinde doğrulandı (2026-07-15): `contacts`/`dispatch_jobs` migration'ları ve `dispatch-alert` Edge Function'ı production'da uygulanmış/deploy edilmiş olduğu REST API ile doğrulandı. Tarayıcıda elle click-through (7 senaryo) kullanıcıya bırakıldı.
