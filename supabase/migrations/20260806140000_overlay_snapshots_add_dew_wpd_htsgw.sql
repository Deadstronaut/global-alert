-- overlay_snapshots: add Dew (Air), WPD (Air), HTSGW (Ocean) — spec 054
-- follow-up, 2026-08-06. dew_point/wind_power_density are GFS-native
-- (same as Temp/RH/CAPE/...); significant_wave_height reuses the same
-- WAVEWATCH III GRIB2 already fetched for Animate: Waves. Only the CHECK
-- constraint changes.
