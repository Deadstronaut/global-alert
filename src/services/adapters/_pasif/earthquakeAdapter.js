// (PASİF — kullanılmıyor) Bu dosyaya hiçbir yerden import yok; gerçek ingestion pipeline
// server/src/sources/ -> server/src/processors/normalizer.js -> Supabase üzerinden çalışıyor.
// Silinmedi, sadece bilgi amaçlı _pasif/ altına taşındı.
